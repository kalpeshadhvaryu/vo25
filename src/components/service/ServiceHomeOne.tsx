...
const service_data: DataType[] = [
  {
    ...
    des: `We craft and develop high-performance web and mobile applications tailored to your business needs. Our solutions focus on scalability, security, and user experience, ensuring seamless functionality and growth in the digital landscape.`
  },
  {
    id: 2,
    title: `Artificial Intelligence & Machine Learning`,
    des: `We leverage AI & ML to build smart, data-driven solutions that enhance automation, improve decision-making, and optimize business processes. Our expertise helps businesses unlock new opportunities, streamline operations, and stay ahead in a competitive market.`
  },
  {
    id: 3,
    title: `Strategic Digital Marketing`,
    des: `We create data-driven digital marketing strategies that enhance brand visibility, drive engagement, and maximize conversions. From SEO and social media marketing to paid ads and content strategy, we help businesses reach the right audience and achieve measurable growth.`
  },
  {
    id: 4,
    title: `Creative Design & Branding Services`,
    des: `We craft visually compelling designs and strong brand identities that leave a lasting impact. From logo creation and UI/UX design to complete brand development, we ensure your business stands out with a unique and cohesive visual presence.`
  },
