...
const about_content: DataType = {
  subtitle: `Our Journey From 2008`,
  title: `How VeravalOnline is Redefining Technology to Drive Global Business Success`,
  des: `VeravalOnline leverages advanced technology, AI, and digital innovation to help businesses worldwide streamline operations, enhance engagement, and accelerate growth. From intelligent automation and custom development to data-driven marketing and branding, we push the limits of technology to create impactful and future-ready solutions for global success.`,
}
